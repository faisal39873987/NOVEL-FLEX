...
class SupabaseIntegrationService {
  ...
  Future<List<Map<String, dynamic>>> getSubcategories(String categoryId) {
    return categories.getSubcategories(categoryId);
  }

  Future<List<Map<String, dynamic>>> getBookPdfFiles(String bookId) {
    return books.getBookChapters(bookId);
  }
