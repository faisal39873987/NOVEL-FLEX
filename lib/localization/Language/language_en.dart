...
class LanguageEn extends Languages {
  ...
  String get dialogTitleY =>
      "Congratulation You can publish free with Us and Get benefits in \$";

  @override
  String get dialogTitleN =>
      "Have a good day, You are reader, you cannot publish Novels only Author can publish Novels you can register as Author for free";
  ...
  @override
  String get textbook =>
      "Text Book Already Published You can Edit in Your Profile";
  ...
  String get beneFicts2 =>
      """Read both free & paid Contents  in the Application\n
  ...
  String get amountWithDraw =>
      "Sorry you don't have sufficient Balance to With draw, You must have at least 5 \$ in your Account";
  ...
  String get copyRight2 =>
      """The Novelx platform is an electronic platform where everyone can publish our various works, but if there is a complaint about business theft, the work will be verified by our team and removed from the site without referring to the author.
  ...
  String get submission2 =>
      """It is possible to apply for activating the wallet after passing the conditions. The account will be verified within three working days only.\n
  ...
  String get ourCondition =>
      "What are the conditions for activating the wallet and withdrawing?";

  @override
  String get ourCondition2 =>
      "Conditions for applying to activate the wallet and reap profits from the monthly subscription and ads.";
  ...
  String get readerWin2 =>
      "Readers can profit through a participant or the application for friends accused of the platform, as they will receive 10% of the value of each person’s subscription. The amount will be placed in their electronic wallet for the platform.";

  @override
  String get privateAds2 =>
      "For the first time, through novel and manga publishing sites, Novelx offers a free advertisement service on the author's page, where authors can contract with third parties, agreeing on the price and duration, and publish an advertisement on their page. As shown below.";

  @override
  String get fanSupport2 =>
      "Support can be obtained from fans of the author's work by sending material gifts through the author's account. There will be a fee of only 5% of the value of the gift for the platform.";

  @override
  String get mangaka_text =>
      "All authors who have passed the conditions for the number of followers can activate the portfolio and get a monthly income from the net profit according to the number of followers and the profit percentage shown below.";
  ...
  String get carefulText =>
      "Please make sure you fill all the Above fields Correctly, If You enter wrong Details Company  will not responsible for any inconvenience";
  ...
  String get popText_2 =>
      "You can earn money from adding custom Ads banner to your Profile";
  @override
  ...
  String get oneTimeSub =>
      "One Month Subscription for NovelFlex will cost you  3\$ ";

  @override
  String get afterSub =>
      "After Subscription you will have access to all the books and novels";
  ...
  String get mangaText =>
      "Here is an illustration of how to earn, and it will be explained in detail";
